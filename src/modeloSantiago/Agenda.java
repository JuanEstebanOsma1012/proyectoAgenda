...
@Override
	public String toString() {
		return "Agenda [titulo=" + titulo + ", numContactos=" + numContactos + ", numGrupos=" + numGrupos
				+ ", numCitas=" + numCitas + ", listaContactos=" + Arrays.toString(listaContactos) + ", listaCitas="
				+ Arrays.toString(listaCitas) + ", listaGrupos=" + Arrays.toString(listaGrupos) + "]";
	}
...
/**
  ...
  * @return
  */
	public String crearContacto(String nombre, String correo,String direccion, int edad,String telefono,int tamanioListaGruposContacto, int tamanioListaCitasContacto,Agenda agenda) {
