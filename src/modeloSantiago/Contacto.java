...
public class Contacto {
	...
	public Contacto(String nombre2, String newCorreo, String newDirec, int newEdad, String newTelefono,
			Grupo[] listaGruposContacto2, Cita[] listaCitasContacto2, Agenda agenda2) {
